...
var xr = Object.getPrototypeOf, Er = Object.prototype.hasOwnProperty;
var g = (r13, e) => () => (e || r13((e = { exports: {} }).exports, e), e.exports);
var vr = (r13, e, t, s) => {
  if (e && typeof e == "object" || typeof e == "function") for (let n of wr(e)) !Er.call(r13, n) && n !== t && Et(r13, n, { get: () => e[n], enumerable: !(s = br(e, n)) || s.enumerable });
  return r13;
};
var vt = (r13, e, t) => (t = r13 != null ? gr(xr(r13)) : {}, vr(!r13 || !r13.__esModule ? Et(t, "default", { value: r13, enumerable: true }) : t, r13));
var fe = g((_) => {
  ...
  function Wr(r13, e, t) {
    ...
    r13.setUint32(e, s), r13.setUint32(e + 4, n);
  }
  _.setUint64 = Wr;
  function Ar(r13, e, t) {
  ...
  _.setInt64 = Ar;
  function Dr(r13, e) {
    let t = r13.getInt32(e), s = r13.getUint32(e + 4);
    return t * 4294967296 + s;
  }
  _.getInt64 = Dr;
  function Or(r13, e) {
    let t = r13.getUint32(e), s = r13.getUint32(e + 4);
    return t * 4294967296 + s;
  }
  _.getUint64 = Or;
});
var _e = g((E) => {
  ...
  function Cr(r13) {
    let e = r13.length, t = 0, s = 0;
    for (; s < e; ) {
      let n = r13.charCodeAt(s++);
      if ((n & 4294967168) === 0) {
        t++;
        continue;
  ...
  E.utf8Count = Cr;
  function Ir(r13, e, t) {
    let s = r13.length, n = t, o = 0;
    for (; o < s; ) {
      let a = r13.charCodeAt(o++);
      if ((a & 4294967168) === 0) {
        e[n++] = a;
        continue;
  ...
  function Ur(r13, e, t) {
    e.set(me.encode(r13), t);
  }
  function Nr(r13, e, t) {
    me.encodeInto(r13, e.subarray(t));
  }
  ...
  function jr(r13, e, t) {
    ...
    for (; s < n; ) {
      ...
      if ((i & 128) === 0) o.push(i);
        ...
        let c = r13[s++] & 63, R = r13[s++] & 63;
        o.push((i & 31) << 12 | c << 6 | R);
      } else if ((i & 248) === 240) {
        let c = r13[s++] & 63, R = r13[s++] & 63, d = r13[s++] & 63, M = (i & 7) << 18 | c << 12 | R << 6 | d;
...
var Ae = g((We) => {
  ...
  var rt = class r13 extends Error {
    constructor(e) {
      super(e);
      let t = Object.create(r13.prototype);
      Object.setPrototypeOf(this, t), Object.defineProperty(this, "name", { configurable: true, enumerable: false, value: r13.name });
    }
  };
  We.DecodeError = rt;
});
var st = g((w) => {
  ...
  function jt({ sec: r13, nsec: e }) {
    if (r13 >= 0 && e >= 0 && r13 <= Jr) if (e === 0 && r13 <= qr) {
      let t = new Uint8Array(4);
      return new DataView(t.buffer).setUint32(0, r13), t;
    } else {
      let t = r13 / 4294967296, s = r13 & 4294967295, n = new Uint8Array(8), o = new DataView(n.buffer);
      return o.setUint32(0, e << 2 | t & 3), o.setUint32(4, s), n;
    }
    else {
      let t = new Uint8Array(12), s = new DataView(t.buffer);
      return s.setUint32(0, e), (0, Bt.setInt64)(s, 4, r13), t;
    }
  }
  w.encodeTimeSpecToTimestamp = jt;
  function Lt(r13) {
    let e = r13.getTime(), t = Math.floor(e / 1e3), s = (e - t * 1e3) * 1e6, n = Math.floor(s / 1e9);
    return { sec: t + n, nsec: s - n * 1e9 };
  }
  w.encodeDateToTimeSpec = Lt;
  function Ft(r13) {
    if (r13 instanceof Date) {
      let e = Lt(r13);
      return jt(e);
    } else return null;
  }
  ...
  function Vt(r13) {
    let e = new DataView(r13.buffer, r13.byteOffset, r13.byteLength);
    switch (r13.byteLength) {
      case 4:
      ...
      default:
        throw new Vr.DecodeError(`Unrecognized data size for timestamp (expected 4, 8, or 12): ${r13.length}`);
    }
  }
...
var nt = g((te) => {
  ...
  function Jt(r13) {
    return r13 instanceof Uint8Array ? r13 : ArrayBuffer.isView(r13) ? new Uint8Array(r13.buffer, r13.byteOffset, r13.byteLength) : r13 instanceof ArrayBuffer ? new Uint8Array(r13) : Uint8Array.from(r13);
  }
  te.ensureUint8Array = Jt;
  function zr(r13) {
    if (r13 instanceof ArrayBuffer) return new DataView(r13);
    let e = Jt(r13);
...
var zt = g((Ie) => {
  ...
  Ie.encode = void 0;
  var Xr = at(), Kr = {};
  function Qr(r13, e = Kr) {
    return new Xr.Encoder(e.extensionCodec, e.context, e.maxDepth, e.initialBufferSize, e.sortKeys, e.forceFloat32, e.ignoreUndefined, e.forceIntegerToFloat).encodeSharedRef(r13);
  }
  Ie.encode = Qr;
});
var Gt = g((Ue) => {
  ...
  function Yr(r13) {
    return `${r13 < 0 ? "-" : ""}0x${Math.abs(r13).toString(16).padStart(2, "0")}`;
  }
  Ue.prettyByte = Yr;
});
var $t = g((Ne) => {
...
var Be = g((j) => {
  ...
  var lt = Gt(), rs = Ce(), X = fe(), ct = _e(), ut = nt(), ss = $t(), B = Ae(), ns = (r13) => {
    let e = typeof r13;
...
var ht = g((C) => {
  ...
  function is(r13, e = C.defaultDecodeOptions) {
    return new Kt.Decoder(e.extensionCodec, e.context, e.maxStrLength, e.maxBinLength, e.maxArrayLength, e.maxMapLength, e.maxExtLength).decode(r13);
  }
  C.decode = is;
  function ls(r13, e = C.defaultDecodeOptions) {
    return new Kt.Decoder(e.extensionCodec, e.context, e.maxStrLength, e.maxBinLength, e.maxArrayLength, e.maxMapLength, e.maxExtLength).decodeMulti(r13);
  }
  C.decodeMulti = ls;
});
var Zt = g((q) => {
  ...
  function Qt(r13) {
    return r13[Symbol.asyncIterator] != null;
  }
  q.isAsyncIterable = Qt;
  function cs(r13) {
    if (r13 == null) throw new Error("Assertion Failure: value must not be null nor undefined");
  }
  async function* Yt(r13) {
    let e = r13.getReader();
    try {
      for (; ; ) {
...
var tr = g((I) => {
  ...
  async function ps(r13, e = je.defaultDecodeOptions) {
    let t = (0, ft.ensureAsyncIterable)(r13);
  ...
  I.decodeAsync = ps;
  function ds(r13, e = je.defaultDecodeOptions) {
    let t = (0, ft.ensureAsyncIterable)(r13);
  ...
  function er(r13, e = je.defaultDecodeOptions) {
    let t = (0, ft.ensureAsyncIterable)(r13);
  ...
  function hs(r13, e = je.defaultDecodeOptions) {
    return er(r13, e);
  }
  I.decodeStream = hs;
});
...
function oe(r13) {
  return !!r13 && typeof r13 == "object" && Object.keys(W).includes(r13.type);
}
function H(r13) {
  return !!r13 && typeof r13 == "object" && "re" in r13 && "im" in r13;
}
var l = {};
function Tt(r13) {
  Object.keys(r13).forEach((e) => l._free(r13[e]));
}
function ae(r13) {
  return l._Rf_protect(A(r13)), r13;
}
function y(r13, e) {
  return l._Rf_protect(A(r13)), ++e.n, r13;
}
function St(r13) {
  let e = l._malloc(4);
  return l._R_ProtectWithIndex(A(r13), e), { loc: l.getValue(e, "i32"), ptr: e };
}
function kt(r13) {
  l._Rf_unprotect(1), l._free(r13.ptr);
}
function _t(r13, e) {
  return l._R_Reprotect(A(r13), e.loc), r13;
}
function b(r13) {
  l._Rf_unprotect(r13);
}
function Ge(r13, e, t) {
  l._Rf_defineVar(A(e), A(t), A(r13));
}
function $e(r13, e) {
  let t = {}, s = { n: 0 };
  try {
    let n = new le(e);
    y(n, s), t.code = l.allocateUTF8(r13);
...
function ie(r13, e) {
  return l.getWasmTableEntry(l.GOT.ffi_safe_eval.value)(A(r13), A(e));
}
var Tr = /* @__PURE__ */ new WeakMap();
function Mt(r13, e) {
  return Tr.set(r13, e), r13;
}
var Xe = 63;
function Q() {
  let r13 = Array.from({ length: 4 }, Sr).join("-");
  if (r13.length !== Xe) throw new Error("comlink internal error: UUID has the wrong length");
  return r13;
}
function Sr() {
  let r13 = Math.floor(Math.random() * Number.MAX_SAFE_INTEGER).toString(16), e = 15 - r13.length;
  return e > 0 && (r13 = Array.from({ length: e }, () => 0).join("") + r13), r13;
}
function A(r13) {
  return Te(r13) ? r13.ptr : r13;
}
function G(r13, e) {
  if (l._TYPEOF(r13.ptr) !== W[e]) throw new Error(`Unexpected object type "${r13.type()}" when expecting type "${e}"`);
}
function At(r13) {
  if (oe(r13)) return new (Dt(r13.type))(r13);
  if (typeof r13 > "u") return new ce();
  if (r13 && typeof r13 == "object" && "type" in r13 && r13.type === "null") return new ce();
  if (r13 === null) return new z({ type: "logical", names: null, values: [null] });
  if (typeof r13 == "boolean") return new z(r13);
  if (typeof r13 == "number") return new ye(r13);
  if (typeof r13 == "string") return new N(r13);
  if (H(r13)) return new ve(r13);
  if (ArrayBuffer.isView(r13) || r13 instanceof ArrayBuffer) return new Pe(r13);
  if (Array.isArray(r13)) return kr(r13);
  if (typeof r13 == "object") return de.fromObject(r13);
  throw new Error("R object construction for this JS object is not yet supported.");
}
function kr(r13) {
  let e = { n: 0 };
  if (r13.every((s) => s && typeof s == "object" && !Te(s) && !H(s))) {
    let s = r13, n = s.every((a) => Object.keys(a).filter((i) => !Object.keys(s[0]).includes(i)).length === 0 && Object.keys(s[0]).filter((i) => !Object.keys(a).includes(i)).length === 0), o = s.every((a) => Object.values(a).every((i) => Ct(i) || Ot(i)));
    if (n && o) return de.fromD3(s);
  }
  if (r13.every((s) => typeof s == "boolean" || s === null)) return new z(r13);
  if (r13.every((s) => typeof s == "number" || s === null)) return new ye(r13);
  if (r13.every((s) => typeof s == "string" || s === null)) return new N(r13);
  try {
    let s = new F([new k("c"), ...r13]);
    return y(s, e), s.eval();
  } finally {
    b(e.n);
  }
...
var f = class {
  ...
  subset(e) {
    return this.#e(e, x.bracketSymbol.ptr);
  }
  get(e) {
    return this.#e(e, x.bracket2Symbol.ptr);
  }
  getDollar(e) {
    return this.#e(e, x.dollarSymbol.ptr);
  }
  #e(e, t) {
    let s = { n: 0 };
    try {
      ...
      return y(o, s), r.wrap(ie(o, x.baseEnv));
    } finally {
      b(s.n);
    }
  }
  ...
  set(e, t) {
    ...
    try {
      ...
      return y(i, s), r.wrap(ie(i, x.baseEnv));
    } finally {
      b(s.n);
    }
  }
...
}, ue = class r2 extends p {
  constructor(e) {
    if (e instanceof f) return G(e, "pairlist"), super(e), this;
    let t = { n: 0 };
    try {
      let { names: s, values: n } = Z(e), o = r2.wrap(l._Rf_allocList(n.length));
      y(o, t);
...
}, F = class r3 extends p {
  constructor(e) {
    if (e instanceof f) return G(e, "call"), super(e), this;
    let t = { n: 0 };
    try {
      let { values: s } = Z(e), n = s.map((a) => y(new p(a), t)), o = r3.wrap(l._Rf_allocVector(W.call, s.length));
      y(o, t);
  ...
  constructor(e, t = null) {
    ...
    try {
      ...
      y(o, s), n.values.forEach((i, c) => {
        It(i) ? l._SET_VECTOR_ELT(o, c, new r4(i).ptr) : l._SET_VECTOR_ELT(o, c, new p(i).ptr);
      });
      let a = t || n.names;
...
}, he = class r6 extends p {
  static {
    this.CEType = { CE_NATIVE: 0, CE_UTF8: 1, CE_LATIN1: 2, CE_BYTES: 3, CE_SYMBOL: 5, CE_ANY: 99 };
  }
  constructor(e) {
    if (e instanceof f) {
      G(e, "string"), super(e);
    ...
    let t = l.allocateUTF8(e);
    try {
      super(new f(l._Rf_mkCharCE(t, r6.CEType.CE_UTF8)));
    } finally {
      l._free(t);
    }
  }
...
}, z = class r7 extends V {
  constructor(e) {
    super(e, "logical", r7.#e);
  }
  static #e = (e) => {
...
}, Ke = class r8 extends V {
  constructor(e) {
    super(e, "integer", r8.#e);
  }
  static #e = (e) => {
...
}, ve = class r10 extends V {
  constructor(e) {
    super(e, "complex", r10.#e);
  }
  static #e = (e) => {
...
}, N = class r11 extends V {
  constructor(e) {
    super(e, "character", r11.#e);
  }
  static #e = (e) => (t, s) => {
...
}, Pe = class r12 extends V {
  constructor(e) {
    e instanceof ArrayBuffer && (e = new Uint8Array(e)), super(e, "raw", r12.#e);
  }
  static #e = (e) => {
    let t = l._RAW(e);
    return (s, n) => {
...
function Z(r13) {
  return oe(r13) ? r13 : Array.isArray(r13) || ArrayBuffer.isView(r13) ? { names: null, values: r13 } : r13 && typeof r13 == "object" && !H(r13) ? { names: Object.keys(r13), values: Object.values(r13) } : { names: null, values: [r13] };
}
function Dt(r13) {
  ...
  return r13 in e ? e[r13] : p;
}
function Te(r13) {
  return r13 instanceof p;
}
function Ot(r13) {
  let e = ["logical", "integer", "double", "complex", "character"];
  return Te(r13) && e.includes(r13.type()) || Te(r13) && r13.isNa();
}
function Ct(r13) {
  return r13 === null || typeof r13 == "number" || typeof r13 == "boolean" || typeof r13 == "string" || H(r13);
}
var x;
function $() {
  let r13 = { resolve: (() => {
    ...
    r13.resolve = t, r13.reject = s;
  });
  return r13.promise = e, r13;
}
function Ut(r13) {
  return new Promise((e) => setTimeout(e, r13));
}
function D(r13, e, t, ...s) {
  return r13 == null || Mr(r13) ? r13 : r13 instanceof ArrayBuffer ? new Uint8Array(r13) : e(r13) ? t(r13, ...s) : Array.isArray(r13) || ArrayBuffer.isView(r13) ? r13.map((n) => D(n, e, t, ...s)) : r13 instanceof f ? r13 : typeof r13 == "object" ? Object.fromEntries(Object.entries(r13).map(([n, o]) => [n, D(o, e, t, ...s)])) : r13;
}
function ee(r13, e, t, s, n = true) {
  let o = new XMLHttpRequest();
  o.open("get", r13, n), o.onload = () => {
    ...
    t ? t(new Error(`Network error loading ${r13}`)) : console.error(`Network error loading ${r13}`);
  }, o.send();
}
function Se(r13) {
  if (h) return false;
  let e = new URL(location.href), t = new URL(r13, location.origin);
  return !(e.host === t.host && e.port === t.port && e.protocol === t.protocol);
}
function Mr(r13) {
  return typeof ImageBitmap < "u" && r13 instanceof ImageBitmap;
}
function It(r13) {
  return typeof r13 == "object" && r13 !== null && !Array.isArray(r13) && !ArrayBuffer.isView(r13) && !H(r13) && !oe(r13) && !(r13 instanceof Date) && !(r13 instanceof RegExp) && !(r13 instanceof Error) && !(r13 instanceof f) && Object.getPrototypeOf(r13) === Object.prototype;
}
var ir = vt(nr());
var bs = new TextEncoder();
async function K(r13, e, t) {
  try {
    let { taskId: s, sizeBuffer: n, dataBuffer: o, signalBuffer: a } = e, i = (0, ir.encode)(t), c = i.length <= o.length;
    if (Atomics.store(n, 0, i.length), Atomics.store(n, 1, +c), !c) {
      let [R, d] = ws(r13);
      o.set(bs.encode(R)), await or(a, s), o = (await d).dataBuffer;
    }
    o.set(i), Atomics.store(n, 1, 1), await or(a, s);
  } catch (s) {
    console.warn(s);
  }
}
function ws(r13) {
  ...
  return [e, new Promise((t) => {
    h ? r13.once("message", (s) => {
      !s.id || s.id !== e || t(s);
    }) : r13.addEventListener("message", function s(n) {
      !n.data || !n.data.id || n.data.id !== e || (r13.removeEventListener("message", s), t(n.data));
    }), r13.start && r13.start();
  })];
}
async function or(r13, e) {
  let t = (e >> 1) % 32, s = 1;
  for (; Atomics.compareExchange(r13, t + 1, 0, e) !== 0; ) await Ut(s), s < 32 && (s *= 2);
  Atomics.or(r13, 0, 1 << t), Atomics.notify(r13, 0);
}
var se = class {
  #e;
  #t;
  ...
  put(e) {
    this.#t.length || this.#r(), this.#t.shift()(e);
  }
  async get() {
    return this.#e.length || this.#r(), this.#e.shift();
  }
  isEmpty() {
...
function lr(r13, e, t) {
  return cr({ type: "response", data: { uuid: r13, resp: e } }, t);
}
function cr(r13, e) {
  return e && Mt(r13, e), r13;
}
function ur(r13) {
  let e = new T(r13.obj.message);
  return r13.obj.name == "ErrnoError" ? e.message = `ErrnoError: ${String(r13.obj.errno)}` : r13.obj.name !== "Error" && (e.name = r13.obj.name), e.stack = r13.obj.stack, e;
}
function xs(r13) {
  return !!r13 && typeof r13 == "object" && "payloadType" in r13 && "obj" in r13;
}
function Fe(r13) {
  return xs(r13) && r13.payloadType === "ptr";
}
var ne = class {
  constructor() {
    this.inputQueue = new se();
    this.outputQueue = new se();
    this.systemQueue = new se();
  ...
  write(e) {
    if (this.#t) throw new S("The webR communication channel has been closed.");
    this.inputQueue.put(e);
  }
  async request(e, t) {
    let s = Rt(e, t), { resolve: n, reject: o, promise: a } = $();
    return this.#e.set(s.data.uuid, { resolve: n, reject: o }), this.write(s), a;
  }
  putClosedMessage() {
    this.#t = true, this.outputQueue.put({ type: "closed" });
  }
  resolveResponse(e) {
    let t = e.data.uuid, s = this.#e.get(t);
    if (s) {
      let n = e.data.resp.data;
      this.#e.delete(t), n.payloadType === "err" ? s.reject(ur(n)) : s.resolve(n);
...
var Ve = class {
  constructor(e) {
    this.chan = e;
    h ? this.WebSocket = "WebSocket" in globalThis ? globalThis.WebSocket : pr() : this.WebSocket = WebSocket;
  }
  #e = /* @__PURE__ */ new Map();
  new(e, t, s) {
  ...
  close(e, t, s) {
    this.#e.get(e)?.close(t, s), this.#e.delete(e);
  }
};
...
var qe = class {
  ...
  postMessage(e) {
    let { uuid: t, async: s, handles: n, data: o, transfer: a } = e.data, i = this.#e.get(t);
    if (!i) throw new Error(`Worker with uuid ${t} not found`);
    if (!s && n) {
      let c = (R) => {
        let d = R.data.uuid, M = R.data.result, Ee = R.data.error;
        d === t && (Ee ? n.reject(new Error(Ee)) : n.resolve(M), i.removeEventListener("message", c));
      };
      i.addEventListener("message", c);
    }
    i.postMessage({ uuid: t, data: o }, { transfer: a });
  }
  terminate(e) {
...
var we = class extends ne {
  constructor(t) {
    ...
    this.#r = async (t2, s2) => {
      if (!(!s2 || !s2.type)) switch (s2.type) {
        case "resolve":
          this.#e = new Int32Array(s2.data), this.resolve();
          return;
        case "response":
        ...
        case "sync-request": {
          ...
          switch (o.type) {
            ...
            case "eval-await": {
              let i = o.data, c = {};
              try {
                c.result = await (0, eval)(i), typeof c.result == "function" && (c.result = String(c.result));
              } catch (R) {
                let d = R;
                c.error = d.message;
              }
              await K(t2, a, { type: "eval-response", data: c });
              break;
            }
            case "post-message-worker": {
              let i = o.data;
              i.handles = $(), this.systemQueue.put({ type: "postMessageWorker", data: i }), i.async ? await K(t2, a, { type: "post-message-response" }) : i.handles.promise.then((c) => {
                K(t2, a, { type: "post-message-response", data: { result: c } });
              }, (c) => {
                K(t2, a, { type: "post-message-response", data: { error: String(c) } });
              });
              break;
            }
            default:
              throw new S(`Unsupported request type '${o.type}'.`);
          }
          return;
        }
        case "request":
          throw new S("Can't send messages of type 'request' from a worker. Please Use 'sync-request' instead.");
      }
    };
    ...
    let s = (n) => {
      ...
      let o = { type: "init", data: { config: t, channelType: U.SharedArrayBuffer } };
      n.postMessage(o);
    };
    if (Se(t.baseUrl)) ee(`${t.baseUrl}webr-worker.js`, (n) => s(n), (n) => {
      this.reject(new T(`Worker loading error: ${n.message}`));
    });
    else {
  ...
  #e;
  emit(t) {
    if (!this.#e) throw new S("Failed attempt to interrupt before initialising interruptBuffer");
    this.eventQueue.push({ type: "event", data: { msg: t } }), this.#e[0] = 1;
  }
  interrupt() {
  ...
  #t(t) {
    h ? (t.on("message", (s) => {
      ...
      console.error(n), this.reject(new T(`An error occurred initialising the webR SharedBufferChannel worker: ${n}.`));
    })) : (t.onmessage = (s) => this.#r(t, s.data), t.onerror = (s) => {
      let n = s instanceof Error ? s.message : String(s);
      console.error(n), this.reject(new T(`An error occurred initialising the webR SharedBufferChannel worker: ${n}.`));
    });
  }
...
var xe = class extends ne {
  constructor(t) {
    ...
    this.#r = async (t2, s2) => {
      if (!(!s2 || !s2.type)) switch (s2.type) {
        ...
        case "request": {
          ...
          switch (o.type) {
            case "read": {
              ...
              if (this.#e) {
                let i = lr(n.data.uuid, a);
                this.#e.postMessage(i);
              }
              break;
            }
            default:
        ...
        case "sync-request":
          throw new S("Can't send messages of type 'sync-request' in PostMessage mode. Use 'request' instead.");
      }
    };
    ({ resolve: this.resolve, reject: this.reject, promise: this.initialised } = $());
    let s = (n) => {
      this.#e = n, this.#t(n), this.close = () => {
        n.terminate(), this.putClosedMessage();
      };
      let o = { type: "init", data: { config: t, channelType: U.PostMessage } };
      n.postMessage(o);
    };
    if (Se(t.baseUrl)) ee(`${t.baseUrl}webr-worker.js`, (n) => s(n), (n) => {
      this.reject(new T(`Worker loading error: ${n.message}`));
  ...
  #t(t) {
    h ? (t.on("message", (s) => {
      ...
      console.error(s), this.reject(new T("An error occurred initialising the webR PostMessageChannel worker."));
    })) : (t.onmessage = (s) => this.#r(t, s.data), t.onerror = (s) => {
      console.error(s), this.reject(new T("An error occurred initialising the webR PostMessageChannel worker."));
    });
  }
...
function fr(r13) {
  return !!(m(r13) && r13._payload.obj.methods?.includes("exec"));
}
function Ps() {
}
function Ts(r13, e) {
  return async function* () {
    let t = { type: "callRObjectMethod", data: { payload: e._payload, prop: "getPropertyValue", args: [{ payloadType: "raw", obj: "length" }], shelter: void 0 } }, s = await r13.request(t);
    if (typeof s.obj != "number") throw new P("Cannot iterate over object, unexpected type for length property.");
    for (let n = 1; n <= s.obj; n++) yield e.get(n);
  };
}
function mr(r13, e, t) {
  return async (...s) => {
    let n = s.map((i) => m(i) ? i._payload : { obj: D(i, m, (c) => c._payload), payloadType: "raw" }), o = { type: "callRObjectMethod", data: { payload: t, prop: e, args: n } }, a = await r13.request(o);
    switch (a.payloadType) {
      case "ptr":
        return J(r13, a);
      case "raw":
        return D(a, Fe, (c, R) => J(R, c), r13).obj;
    }
  };
}
async function Ss(r13, e, t, ...s) {
  let n = { type: "newRObject", data: { objType: e, args: D(s, m, (a) => a._payload), shelter: t } }, o = await r13.request(n);
  switch (o.payloadType) {
    case "raw":
      throw new L("Unexpected raw payload type returned from newRObject");
    case "ptr":
      return J(r13, o);
  }
}
function J(r13, e) {
  let t = new Proxy(e.obj.methods?.includes("exec") ? Object.assign(Ps, { ...e }) : e, { get: (s, n) => {
    if (n === "_payload") return e;
    if (n === Symbol.asyncIterator) return Ts(r13, t);
    if (e.obj.methods?.includes(n.toString())) return mr(r13, n.toString(), e);
  }, apply: async (s, n, o) => {
    let a = await J(r13, e).exec(...o);
    return fr(a) ? a : a.toJs();
  } });
  return t;
}
function v(r13, e, t) {
  return new Proxy(p, { construct: (s, n) => Ss(r13, t, e, ...n), get: (s, n) => mr(r13, n.toString()) });
}
var ks = { FONTCONFIG_PATH: "/etc/fonts", R_HOME: "/usr/lib/R", R_ENABLE_JIT: "0", ALL_PROXY: "socks5h://localhost:8580", WEBR: "1", WEBR_VERSION: bt, R_VERSION: wt }, Rr = { RArgs: [], REnv: ks, baseUrl: hr, serviceWorkerUrl: "", repoUrl: yr, homedir: "/home/web_user", interactive: true, channelType: U.Automatic, createLazyFilesystem: true }, Je = class {
  constructor(e = {}) {
    this.version = bt;
    this.versionR = wt;
    this.FS = { analyzePath: async (e2, t2) => {
      let s = { type: "analyzePath", data: { path: e2, dontResolveLastLink: t2 } };
      return (await this.#e.request(s)).obj;
    }, lookupPath: async (e2) => {
      let t2 = { type: "lookupPath", data: { path: e2 } };
      return (await this.#e.request(t2)).obj;
    }, mkdir: async (e2) => {
      let t2 = { type: "mkdir", data: { path: e2 } };
      return (await this.#e.request(t2)).obj;
    }, mount: async (e2, t2, s) => {
      let n = [];
      "blobs" in t2 && t2.blobs && (n = [...n, ...t2.blobs.map((a) => a.data instanceof Blob ? a.data.arrayBuffer().then((i) => {
        a.data = new Uint8Array(i);
      }) : Promise.resolve())]), "packages" in t2 && t2.packages && (n = [...n, ...t2.packages.map((a) => a.blob instanceof Blob ? a.blob.arrayBuffer().then((i) => {
        a.blob = new Uint8Array(i);
      }) : Promise.resolve())]), await Promise.all(n);
      let o = { type: "mount", data: { type: e2, options: t2, mountpoint: s } };
      await this.#e.request(o);
    }, syncfs: async (e2) => {
      let t2 = { type: "syncfs", data: { populate: e2 } };
      await this.#e.request(t2);
    }, readFile: async (e2, t2) => {
      let s = { type: "readFile", data: { path: e2, flags: t2 } };
      return (await this.#e.request(s)).obj;
    }, rename: async (e2, t2) => {
      let s = { type: "rename", data: { oldpath: e2, newpath: t2 } };
      await this.#e.request(s);
    }, rmdir: async (e2) => {
      let t2 = { type: "rmdir", data: { path: e2 } };
      await this.#e.request(t2);
    }, writeFile: async (e2, t2, s) => {
      let n = { type: "writeFile", data: { path: e2, data: t2, flags: s } };
      await this.#e.request(n);
    }, unlink: async (e2) => {
  ...
  async #n() {
    for (; ; ) {
      ...
      switch (e.type) {
        ...
        case "proxyWebSocket": {
          let t = e;
          this.#t.new(t.data.uuid, t.data.url, t.data.protocol);
          break;
        }
        case "sendWebSocket": {
          let t = e;
          this.#t.send(t.data.uuid, t.data.data);
          break;
        }
        case "closeWebSocket": {
          let t = e;
          this.#t.close(t.data.uuid, t.data.code, t.data.reason);
          break;
        }
        case "proxyWorker": {
          let t = e;
          this.#r.new(t.data.uuid, t.data.url, t.data.options);
          break;
        }
        case "postMessageWorker": {
          let t = e;
          this.#r.postMessage(t);
          break;
        }
        case "terminateWorker": {
          let t = e;
          this.#r.terminate(t.data.uuid);
          break;
        }
        case "console.log":
          console.log(e.data);
        ...
        case "close":
          ...
          break;
        default:
          throw new P("Unknown system message type `" + e.type + "`");
      }
    }
  }
  close() {
...
` });
  ...
  async evalRRaw(e, t, s = {}) {
    let n = D(s, m, (i) => i._payload), o = { type: "evalRRaw", data: { code: e, options: n, outputType: t } }, a = await this.#e.request(o);
    switch (a.payloadType) {
      case "raw":
        return a.obj;
      case "ptr":
        throw new L("Unexpected ptr payload type returned from evalRVoid");
    }
  }
  ...
  async init() {
    if (this.#r) return;
    let e = { type: "newShelter" }, t = await this.#t.request(e);
    this.#e = t.obj, this.RObject = v(this.#t, this.#e, "object"), this.RLogical = v(this.#t, this.#e, "logical"), this.RInteger = v(this.#t, this.#e, "integer"), this.RDouble = v(this.#t, this.#e, "double"), this.RComplex = v(this.#t, this.#e, "complex"), this.RCharacter = v(this.#t, this.#e, "character"), this.RRaw = v(this.#t, this.#e, "raw"), this.RList = v(this.#t, this.#e, "list"), this.RDataFrame = v(this.#t, this.#e, "dataframe"), this.RPairlist = v(this.#t, this.#e, "pairlist"), this.REnvironment = v(this.#t, this.#e, "environment"), this.RSymbol = v(this.#t, this.#e, "symbol"), this.RString = v(this.#t, this.#e, "string"), this.RCall = v(this.#t, this.#e, "call"), this.#r = true;
  }
  async purge() {
    let e = { type: "shelterPurge", data: this.#e };
    await this.#t.request(e);
  }
  async destroy(e) {
    let t = { type: "shelterDestroy", data: { id: this.#e, obj: e._payload } };
    await this.#t.request(t);
  }
  async size() {
    let e = { type: "shelterSize", data: this.#e };
    return (await this.#t.request(e)).obj;
  }
  async evalR(e, t = {}) {
    let s = D(t, m, (a) => a._payload), n = { type: "evalR", data: { code: e, options: s, shelter: this.#e } }, o = await this.#t.request(n);
    switch (o.payloadType) {
      case "raw":
        throw new L("Unexpected payload type returned from evalR");
      default:
        return J(this.#t, o);
    }
  }
  async captureR(e, t = {}) {
    let s = D(t, m, (a) => a._payload), n = { type: "captureR", data: { code: e, options: s, shelter: this.#e } }, o = await this.#t.request(n);
    switch (o.payloadType) {
      case "ptr":
        throw new L("Unexpected payload type returned from evalR");
      case "raw": {
        let a = o.obj, i = J(this.#t, a.result), c = a.output, R = a.images;
        for (let d = 0; d < c.length; ++d) c[d].type !== "stdout" && c[d].type !== "stderr" && (c[d].data = J(this.#t, c[d].data));
        return { result: i, output: c, images: R };
      }
    }
  }
};
function _s(r13) {
  return new Proxy(He, { construct: async () => {
    let e = new He(r13);
...
class MovecostEngine {
  ...
  emit(phase, message, fraction = null) {
    const event = { phase, message, fraction };
    for (const listener of this.listeners) {
      try {
        listener(event);
      } catch {
  ...
  async boot() {
    ...
    this.booting = (async () => {
      ...
      await webR.init();
      const total = R_PACKAGES.reduce((sum, p2) => sum + (R_PACKAGE_WEIGHTS[p2] ?? 1), 0);
      let done = 0;
  ...
  async runNow(request, inputs) {
    ...
    const response = JSON.parse(new TextDecoder().decode(raw));
...
async function ensureDir(webR, path) {
  try {
...
function getRamp(id) {
  return COLOUR_RAMPS.find((r13) => r13.id === id) ?? COLOUR_RAMPS[0];
}
function decodeRaster(payload) {
...
function sample(ramp, t) {
  ...
  const b2 = stops[i + 1];
  return [
    Math.round(a[0] + (b2[0] - a[0]) * f2),
    Math.round(a[1] + (b2[1] - a[1]) * f2),
    Math.round(a[2] + (b2[2] - a[2]) * f2)
  ];
}
function renderRasterToCanvas(raster, options = {}) {
  ...
  for (let i = 0; i < raster.values.length; i += 1) {
    ...
    let t = (v2 - lo) / span;
    t = t < 0 ? 0 : t > 1 ? 1 : t;
    const [r13, g2, b2] = sample(ramp, options.reverse ? 1 - t : t);
    out[o] = r13;
    out[o + 1] = g2;
    out[o + 2] = b2;
    out[o + 3] = alpha;
...
let overlaySeq = 0;
function addRasterOverlay(app, raster, options) {
  const map = app.getMap?.() ?? null;
  if (!map) return null;
...
function removeOverlay(map, layerId, sourceId) {
  try {
...
function renderLegend(ramp, reverse = false) {
  ...
  for (let x2 = 0; x2 < canvas.width; x2 += 1) {
    const t = x2 / (canvas.width - 1);
    const [r13, g2, b2] = sample(ramp, reverse ? 1 - t : t);
    ctx.fillStyle = `rgb(${r13},${g2},${b2})`;
...
function field(label, control2, options = {}) {
  const wrapper = el(
    "label",
...
class MovecostPanel {
  ...
  terrainMode = "download";
  area = null;
  demZoom = 12;
  downloadingDem = false;
  /**
  ...
  terrainPreview = null;
  terrainVisible = true;
  origin = emptyPointSet();
  destination = emptyPointSet();
  ...
  layersSignature() {
    return listVectorLayers(this.app).map((layer) => `${layer.id}:${layer.name ?? ""}`).join("|");
  }
  /**
  ...
  renderDemDownload() {
    ...
    children.push(
      el("p", {
        ...
        text: this.area ? `Area taken from the ${this.area.label}.` : "Draw a polygon over the study area, or use the current map view."
      }),
      field(
        "Detail",
    ...
    if (this.useArea) {
      children.push(
        note(
          "movecost will download elevation on every run. Good for a single analysis; download the DEM once if you plan to compare cost functions.",
          "info"
        )
      );
    }
  ...
  renderPointPicker(which, label, min, max) {
    ...
    const summary = set.features.length ? `${set.features.length} point${set.features.length === 1 ? "" : "s"} from ${set.label}` : `No ${label.toLowerCase()} yet — need ${min}${max && max !== min ? ` to ${max}` : max === min ? "" : " or more"}.`;
    const children = [
  ...
  renderCostSection() {
    ...
    const children = [
      ...
      field(
        "Function",
        select(
          COST_FUNCTIONS.map((f2) => ({ value: f2.id, label: f2.label, group: f2.group })),
          this.params.funct,
          (value) => {
    ...
    if (fn.uses.includes("W")) {
      children.push(
        field("Body weight (kg)", numberInput(this.params.W ?? 70, (v2) => this.params.W = v2, { min: 20, max: 250, step: 1 }), { inline: true })
      );
    }
    if (fn.uses.includes("L")) {
      children.push(
        field("Carried load (kg)", numberInput(this.params.L ?? 0, (v2) => this.params.L = v2, { min: 0, max: 150, step: 1 }), { inline: true })
      );
    }
    if (fn.uses.includes("N")) {
      children.push(
        field("Terrain coefficient", numberInput(this.params.N ?? 1, (v2) => this.params.N = v2, { min: 0.5, max: 5, step: 0.05 }), {
          inline: true,
    ...
    if (fn.uses.includes("V")) {
      children.push(
        field("Speed (m/s)", numberInput(this.params.V ?? 1.2, (v2) => this.params.V = v2, { min: 0, max: 4, step: 0.1 }), {
          inline: true,
    ...
    if (fn.uses.includes("slCrit")) {
      children.push(
        field("Critical slope (%)", numberInput(this.params.slCrit ?? 10, (v2) => this.params.slCrit = v2, { min: 1, max: 30, step: 1 }), {
          inline: true,
  ...
  renderDisplaySection() {
    ...
    return el(
      ...
      field(
        "Colour ramp",
        select(
          COLOUR_RAMPS.map((r13) => ({ value: r13.id, label: r13.label })),
          this.rampId,
          (value) => {
            this.rampId = value;
            this.render();
    ...
    if (this.produced.length) {
      ...
      children.push(
        el(
          ...
          this.app.exportTextFile ? button("Export GeoJSON", () => this.exportResults(response), "secondary") : null
        )
      );
    }
      ...
      for (const [key, value] of Object.entries(tables)) {
        ...
        children.push(
          el(
            ...
            { class: "mcx-table" },
            el("summary", { text: key }),
            el("pre", { class: "mcx-pre", text: JSON.stringify(value, null, 2).slice(0, 2e4) })
          )
        );
      }
    }
  ...
  collectParams() {
    ...
    for (const extra of spec.extras) {
      ...
      if (extra.kind === "numberList") {
        const numbers = String(value).split(/[,;\s]+/).map((part) => Number(part)).filter((n) => Number.isFinite(n));
...
class MovecostControl {
  ...
  onAdd() {
    ...
    button2.type = "button";
    button2.title = "movecost — least-cost analysis";
    button2.setAttribute("aria-label", "movecost — least-cost analysis");
    button2.className = "mcx-ctrl__button";
    button2.innerHTML = ICON_SVG;
    button2.addEventListener("click", this.onToggle);
